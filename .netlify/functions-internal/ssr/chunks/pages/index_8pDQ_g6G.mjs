/* empty css                          */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, g as addAttribute, i as renderTransition, f as renderComponent, e as createAstro } from '../astro_DwIvQ8Gp.mjs';
import { a as $$Svg, $ as $$Layout } from './404_CM9X1WA9.mjs';
/* empty css                          */
import { m as movies, s as series } from './_idMovie__C4ZBHZHS.mjs';
...
const $$AllMovies = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="pt-5 relative before:content-[''] before:absolute before:w-full before:h-[2px] before:rounded-full before:[background-image:linear-gradient(90deg,#38bdf8,#0c4a6e,#0c4a6e,#38bdf8)] before:top-0 w-full"> <h2 class="text-xl font-bold">Películas</h2> <div class="grid grid-cols-[repeat(auto-fill,minmax(130px,1fr))] gap-5 my-5 w-full"> ${movies.map(({ title, image, rating }) => {
    return renderTemplate`${renderComponent($$result, "CardMovie", $$CardMovie, { "name": title, "image": image, "rating": rating })}`;
  })} </div> </section>`;
...
const $$AllSeries = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="pt-5 relative before:content-[''] before:absolute before:w-full before:h-[2px] before:rounded-full before:[background-image:linear-gradient(90deg,#38bdf8,#0c4a6e,#0c4a6e,#38bdf8)] before:top-0"> <h2 class="pb-4 text-xl font-bold">Series</h2> <div class="grid grid-cols-[repeat(auto-fill,minmax(130px,1fr))] gap-5"> ${series.map((serie) => {
    return renderTemplate`${renderComponent($$result, "CardMovie", $$CardMovie, { "name": serie.title, "image": serie.image, "rating": serie.rating })}`;
  })} </div> </section>`;
}, "/mnt/c/Users/Laptop/desktop/MY-PROJECTS/MisPeliculas/src/components/AllSeries.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "MisPeliculas | Proyecto" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="section"> ${renderComponent($$result2, "AllMovies", $$AllMovies, {})} ${renderComponent($$result2, "AllSeries", $$AllSeries, {})} </section> ` })}`;
