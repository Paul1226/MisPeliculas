...
import { $ as $$Layout } from './404_QYebdIzA.mjs';
/* empty css                              */
/* empty css                          */
...
const movies = [
	...
	},
	{
		...
		synopsis: "After the devastating events of Avengers: Infinity War, the universe is in ruins. With the help of remaining allies, the Avengers assemble once more in order to reverse Thanos' Accións and restore balance to the universe.",
	...
	},
	{
		...
		synopsis: "Deckard Shaw seeks revenge against Dominic Toretto and his Familiar for his comatose brother.",
	...
	},
	{
		...
		synopsis: "The Incredibles Familiar takes on a new mission, which involves a change in Familiar roles: Bob Parr (Mr. Incredible) must manage the house while his wife Helen (Elastigirl) goes out to save the world.",
...
const series = [
	...
	},
	{
		...
		synopsis: "A high school chemistry teacher turned methamphetamine producer partners with a former student to secure his Familiar's future.",
	...
	},
	{
		...
		synopsis: "A modern update finds the famous sleuth and his doctor partner solving Crimen in 21st century London.",
	...
	},
	{
		...
		synopsis: "A gangster Familiar epic set in 1919 Birmingham, England and centered on a gang who sew razor blades in the peaks of their caps, and their fierce boss Tommy Shelby.",
	...
	},
	{
		...
		synopsis: "Vikings follows the Aventuras of Ragnar Lothbrok, the greatest hero of his age. The series tells the sagas of Ragnar's band of Viking brothers and his Familiar, as he rises to become King of the Viking tribes.",
